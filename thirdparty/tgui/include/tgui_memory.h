...
#define TGUI_KB(value) ((value)*1024ll)
#define TGUI_MB(value) (TGUI_KB(value)*1024ll)
#define TGUI_GB(value) (TGUI_MB(value)*1024ll)
...
#define TGUI_DEFAULT_VIRTUAL_SPACE_RANGE TGUI_GB(4)
